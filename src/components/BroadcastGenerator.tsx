...
Дополнительно: Используем ускорители строительства, исследований, обучения и лечения. Побеждаем врагов чем выше ранг уничтоженных войск соперника, тем больше очков.`,
  ...
  },
  {
    ...
    text: `БОЕВОЙ ПРИКАЗ: ВОСКРЕСЕНЬЕ (ДЕНЬ 7) — СБРОС И РЕЖИМ ПОЛНОЙ КОПИЛКИ
Полная копилка! СТОП тратам. Готовим длинные стройки и науку на понедельник.
Задания Сокола: Задания Сокола копим на следующую неделю.
