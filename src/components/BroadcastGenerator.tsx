...
Главные задачи: Достраиваем здания строго после старта фазы — очки дают только за клик по молотку завершения. Отправляем караваны и тайные операции, нанимаем выживших.
...
Важно: На ночь обязательно ставим щит. Если щита нет, убедитесь, что убрали войска со стен!`,
...
Дополнительно: Используем ускорители строительства, исследований, обучения и лечения. Побеждаем врагов чем выше ранг уничтоженных войск соперника, тем больше очков.`,
    shortText: `СБ ДЕНЬ 6: Рейд. Караваны UR и тайные операции UR на чужие серверы. Тратим ускорители, крушим врагов ради очков!`,
  },
  {
    id: "sunday",
    title: "Воскресенье (День 7: Режим Копилки)",
    text: `БОЕВОЙ ПРИКАЗ: ВОСКРЕСЕНЬЕ КОПИЛКА
Полная копилка! СТОП тратам. Готовим длинные стройки и науку на понедельник. Режим сбережения. Отдыхаем и копим ресурсы.`,
    shortText: `ВС: Копилка! СТОП тратам. Готовим стройки и науку на ПН. Режим сбережения. Отдыхаем и копим ресурсы.`,
  },
  {
...
День 5 (Пт): Подготовка к Войне — Сдача всего накопленного Сокола. Тренировка войск, плоды и эссенции Ворона, чужие караваны (обязательно ставим галочку запрета!). Тренируем и забираем солдат в день фазы для максимального набора очков.
