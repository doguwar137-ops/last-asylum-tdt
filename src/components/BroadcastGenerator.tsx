...
const PRESET_BROADCASTS = [
  {
    ...
    text: `📢 [tDt] БОЕВОЙ ПРИКАЗ: ПОНЕДЕЛЬНИК (Фаза 1: Технологии, Ворон & Сокол)
...
📊 Норматив дуэли: 1 000 000 очков на сегодня (суточный)!`,
  },
  {
    ...
    text: `📢 [tDt] БОЕВОЙ ПРИКАЗ: ВТОРНИК (Фаза 2 — Стройка)
...
🎯 Норматив дуэли: 1 000 000 очков на сегодня (суточный)!`,
  },
  {
    ...
    text: `📢 [tDt] БОЕВОЙ ПРИКАЗ: СРЕДА (Фаза 3 — Исследования)
...
🎯 Норматив дуэли: 1 000 000 очков на сегодня (суточный)!`,
  ...
  {
    id: "thursday",
    title: "Четверг (Герои + Крыса)",
    text: `📢 [tDt] БОЕВОЙ ПРИКАЗ: ЧЕТВЕРГ (Фаза 4 — Развитие Героев)
...
🎯 Норматив дуэли: 1 000 000 очков на сегодня (суточный)!`,
  },
  {
    ...
    text: `📢 [tDt] БОЕВОЙ ПРИКАЗ: ПЯТНИЦА (Фаза 5 — Войска и Усиление)
🔥 ЗАБИРАЕМ 2-Ю ПАРТИЮ ЗАДАНИЙ СОКОЛА! Кликаем по красному кружку всех накопленных миссий! Крутим караваны, активируем эссенции Ворона, обучаем бойцов по схеме TZ->TY->TX!
📊 Норматив дуэли: 1 000 000 очков на сегодня (суточный)! Проверьте свой счет!`,
  },
  {
    id: "saturday",
    title: "Суббота (Лечение & Засады UR)",
    text: `📢 [tDt] БОЕВОЙ ПРИКАЗ: СУББОТА (Фаза 6 — Лечение & Операции)
...
🎯 Норматив дуэли: 1 000 000 очков на сегодня (суточный)!`,
  },
  {
    ...
    text: `📢 [tDt] РЕЖИМ КОПИЛКИ: ВОСКРЕСЕНЬЕ (Подготовка)
🛡 Полный стоп на трату ускоров и сундуков. Фармим ресурсы обычной энергией. Готовимся к понедельнику!`,
  },
  {
    ...
    text: `📢 [tDt] БОЕВОЙ ПРИКАЗ: ПРАВИЛА СЫРНОЙ ЛОВУШКИ!
🧀 Запуск ралли: СТРОГО одним слабым героем (синим/фиолетовым)! Основу не ставить!
⚔️ Вход в ралли: Вступаем ТОЛЬКО своим основным ударным составом!
...
📍 Игрокам R4: держаться рядом с ловушкой (+5% к урону альянса).`,
  },
  {
    ...
    text: `⚠️ [tDt] ВНИМАНИЕ: ПРОВЕРКА НОРМАТИВА ДУЭЛИ!
🎯 Норматив дуэли: 1 000 000 очков на сегодня (суточный)!
