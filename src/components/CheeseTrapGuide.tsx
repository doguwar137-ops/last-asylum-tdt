        ...
        <div className="rounded-2xl bg-white border border-slate-200 p-5 space-y-3 shadow-2xs">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-bold text-slate-900">
              Запуск штурма: Только слабый герой
            </h3>
          </div>
          <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
            При запуске штурма на Сырную ловушку отправляйте <strong className="text-rose-700">ТОЛЬКО ОДНОГО слабого героя</strong> (синего или фиолетового качества, 1 уровня) с парой солдат (Т1 или Т2).
          </p>
          <div className="p-3 rounded-xl bg-rose-50 border border-rose-200 text-xs text-rose-800 flex items-start gap-2">
            <XCircle className="w-4 h-4 text-rose-600 flex-shrink-0 mt-0.5" />
            <span>Категорически запрещено запускать штурм основным ударным составом! Вы забьете лимит вместимости штурма для соклановцев.</span>
          </div>
        </div>

        {/* Rule 2: Joining Assaults */}
        <div className="rounded-2xl bg-white border border-slate-200 p-5 space-y-3 shadow-2xs">
          <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600">
                Тактический разбор механики штурмов в «Сырной ловушке»
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2.5">
            <div className="flex items-center gap-2.5 text-slate-900 font-bold text-sm">
              ...
              <h4 className="leading-snug">Экономия места для соклановцев (Лимит вместимости штурма)</h4>
            </div>
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
              Когда вы запускаете штурм, максимальный объем войск, который может в него поместиться, жестко ограничен лимитом вместимости штурма. Если вы отправите туда свой полноценный ударный отряд (многотысячную армию), вы забьете весь лимит своими войсками. Соклановцы просто не смогут присоединиться к вашему штурму, из-за чего альянс в сумме наберет меньше очков.
            </p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2.5">
            ...
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
              Синий или фиолетовый герой низкого уровня имеет минимальный параметр лидерства (командования). Он берет с собой буквально пару солдат (Т1 или Т2). Таким образом, ваш штурм открыт, но внутри будете только вы с парой солдат, а всё остальное свободное место (99%) достанется вашим союзникам.
            </p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2.5">
            ...
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
              Свои сильные (ударные) отряды вы должны отправлять на присоединение к штурмам соклановцев (особенно к лидерам R4/R5, у которых есть бонусы к урону). Пока ваш слабый герой идет как организатор штурма, ваши сильные отряды успеют несколько раз быстро сходить в чужие штурмы, нанести колоссальный урон и принести вам максимум личных наград.
            </p>
          </div>
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2.5">
            ...
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
              В этом событии войска получают ранения. Отправляя сильного героя запускать штурм, вы рискуете забить больницу. Слабый герой с парой солдат минимизирует любые траты на лечение.
            </p>
          </div>
        </div>
      </div>
